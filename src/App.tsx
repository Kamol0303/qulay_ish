...
function AppRoutes({ mobile }: { mobile: boolean }) {
  return (
    <Routes>
      <Route path="/" element={mobile ? <HomeMobile /> : <LandingPage />} />
      <Route path="/auth" element={mobile ? <AuthMobile /> : <AuthPage />} />
      ...
      <Route path="/saved-jobs" element={mobile ? <SavedJobsMobile /> : <SavedJobsPage />} />

      <Route
        path="/my-profile"
        element={<ProtectedRoute>{mobile ? <ProfileMobile /> : <MyProfilePage />}</ProtectedRoute>}
      />
      <Route
        path="/chat"
        element={<ProtectedRoute>{mobile ? <ChatMobile /> : <ChatPage />}</ProtectedRoute>}
      />
      <Route
        path="/notifications"
        element={
          <ProtectedRoute>{mobile ? <NotificationsMobile /> : <NotificationsPage />}</ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <RoleProtectedRoute allowedRoles={['super_admin']}>
            {mobile ? <NotificationsMobile /> : <NotificationsPage />}
          </RoleProtectedRoute>
        }
      />
