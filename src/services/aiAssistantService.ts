...
const ALLOWED_TOPICS = [
  ...
  'mexrliqollar.uz', 'dashboard', 'panel',
];
...
const OUT_OF_SCOPE_RESPONSES: Record<AILanguage, string> = {
  uz: "Kechirasiz, men faqat MEXRLI QO'LLAR.UZ platformasi bo'yicha yordam bera olaman. Ish qidirish, ariza topshirish, shartnoma tuzish va platforma xususiyatlari haqida savol bering.",
  ru: "Извините, я могу помочь только по вопросам платформы MEXRLI QO'LLAR.UZ. Задавайте вопросы о поиске работы, подаче заявок, заключении контрактов и функциях платформы.",
  en: "Sorry, I can only help with MEXRLI QO'LLAR.UZ platform-related questions. Ask me about job search, applications, contracts, and platform features."
};
...
const SYSTEM_PROMPTS = {
  worker: `You are a helpful assistant for workers on the mexrliqollar.uz job platform in Uzbekistan.
...
Focus ONLY on platform-related assistance.`,
  ...
  employer: `You are a helpful assistant for employers on the mexrliqollar.uz job platform in Uzbekistan.
...
Focus ONLY on platform-related assistance.`,
  ...
  admin: `You are a helpful assistant for administrators on the mexrliqollar.uz platform.
...
Keep responses concise and professional.`,
  ...
  general: `You are a helpful assistant for the mexrliqollar.uz job platform in Uzbekistan.
...
const MOCK_RESPONSES: Record<AILanguage, {
  ...
  uz: {
    ...
    default: "mexrliqollar.uz platformasida yordam berish uchun shu yerdaman. Ishlar, arizalar, profil, shartnomalar haqida savol bering."
  },
  ru: {
    ...
    default: "\u042f \u0437\u0434\u0435\u0441\u044c, \u0447\u0442\u043e\u0431\u044b \u043f\u043e\u043c\u043e\u0447\u044c \u0432\u0430\u043c \u0441 \u043f\u043b\u0430\u0442\u0444\u043e\u0440\u043c\u043e\u0439 mexrliqollar.uz. \u0421\u043f\u0440\u0430\u0448\u0438\u0432\u0430\u0439\u0442\u0435 \u043e \u0432\u0430\u043a\u0430\u043d\u0441\u0438\u044f\u0445, \u0437\u0430\u044f\u0432\u043a\u0430\u0445, \u043f\u0440\u043e\u0444\u0438\u043b\u0435 \u0438\u043b\u0438 \u043a\u043e\u043d\u0442\u0440\u0430\u043a\u0442\u0430\u0445."
  },
  en: {
    ...
    default: "I'm here to help you with the mexrliqollar.uz platform. Ask me about jobs, applications, profiles, or contracts."
  }
};
