...
export default function ContractPage() {
  ...
  const generatePDF = () => {
    ...
    doc.text("MEXRLI QO'LLAR.UZ", 105, 20, { align: 'center' });
    ...
    doc.text(`${t('jobs.one_time')}: ${job.workType}`, 25, 115);
    ...
    if (contract.adminApproved) {
      ...
      doc.text("APPROVED BY MEXRLI QO'LLAR.UZ ADMIN", 105, 275, { align: 'center' });
  ...
  if (!isMyContract) return <Navigate to="/" replace />;
