...
const PREDEFINED_RESPONSES: Record<AILanguage, Record<string, string>> = {
  uz: {
    ...
    default: `Kechirasiz, men faqat MEXRLI QO'LLAR.UZ platformasi bo'yicha yordam bera olaman. Ish qidirish, ariza topshirish, shartnoma tuzish haqida savol bering.`
  },
  ru: {
    ...
    default: `Извините, я могу помочь только по вопросам платформы MEXRLI QO'LLAR.UZ. Задавайте вопросы о поиске работы, заявках, контрактах.`
  },
  en: {
    ...
    default: `Sorry, I can only help with MEXRLI QO'LLAR.UZ platform questions. Ask about job search, applications, contracts.`
  }
};
